...
const HERO_IMAGE_URL = "/images/student-life-academic-classes-hero.png";
export default async function AcademicClassesPage() {
  const section = getStudentLifeSection("academic-classes");
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-slate-900">
      <PageHero
        src={HERO_IMAGE_URL}
        alt="円形の学習ブースでノートPCを開き、グループで学習・議論する学生たち"
        title={section.title}
      />
