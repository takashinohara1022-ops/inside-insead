...
import { AlumniDirectory } from "../../alumni/_components/alumni-directory";
...
export default function StudentsProfilePage() {
  const section = getAlumniSection("profile");
  if (!section) return null;
  const paragraphs = section.body.split(/\n\n+/).filter(Boolean);

  return (
    <div className="min-h-screen bg-stone-50 text-slate-900">
      <PageHero src={HERO_IMAGE_URL} alt="在校生プロフィール" title={section.title} />
